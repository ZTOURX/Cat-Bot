...
async function main(): Promise<void> {
  ...
  const [
    ...
    prisma.botCredentialDiscord.findMany(),
    prisma.botCredentialTelegram.findMany(),
    prisma.botCredentialFacebookPage.findMany(),
    prisma.botCredentialFacebookMessenger.findMany(),
    ...
    prisma.botUserSession.findMany(),
    prisma.botThreadSession.findMany(),
    prisma.fbPageWebhook.findMany(),
    prisma.botSessionCommand.findMany(),
    prisma.botSessionEvent.findMany(),
    prisma.botUserBanned.findMany(),
    prisma.botThreadBanned.findMany(),
  ]);
